...
????绑定策略的@和=，为什么再定义指令属性的时候一个是表达式，一个是直接属性？和angular的表达式{{}}和内置指令中的值有区别吗？<br>
这里有回答：（https://stackoverflow.com/questions/14050195/what-is-the-difference-between-and-in-directive-scope-in-angularjs）<br>
