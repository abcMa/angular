...
public class BarcodeScanner extends CordovaPlugin {
    ...
    public void scan() {
        ...
        Intent scanIntent = new Intent(appContext, ScannerActivity.class);
        cordova.startActivityForResult(this, scanIntent, REQUEST_CODE);
    }

    public void decode(String url) {
        try {
            ContentResolver resolver = cordova.getActivity().getContentResolver();
            Bitmap imageBitmap = BitmapFactory.decodeStream(resolver.openInputStream(Uri.parse(url)));
            ...
            Log.i("decode", result.getText());
            this.callbackContext.success(result.getText());
        } catch (NotFoundException e) {
            e.printStackTrace();
        } catch (com.google.zxing.NotFoundException e) {
            this.callbackContext.error("图片中未找到二维码");
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
        }
