angular.module('app.controllers').controller('memberInfoCtrl', ["$rootScope", "$scope", "loadDataMixin", "memberCenterService", "errorHandling", "loading", "modals", "toast", "$translate", "dateFilter", "messageCenter", function (
