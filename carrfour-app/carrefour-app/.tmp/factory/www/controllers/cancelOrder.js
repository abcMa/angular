angular.module('app.controllers').controller('cancelOrderCtrl', ["$scope", "$state", "$params", "categoryService", "loadDataMixin", "stateUtils", "orderService", "loading", "errorHandling", "toast", "$translate", function(
