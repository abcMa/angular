 ...
 * 登录弹出层控制器
 */
angular.module('app.controllers').controller('loginCtrl', ["$scope", "$state", "$params", "modals", "globalService", "userService", "errorHandling", "validator", "$translate", "toast", "loading", "messageCenter", function (
