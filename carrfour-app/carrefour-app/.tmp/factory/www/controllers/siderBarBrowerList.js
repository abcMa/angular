angular.module('app.controllers').controller('siderBarBrowerListCtrl', ["$scope", "$state", "stateUtils", "$stateParams", "loadDataMixin", "errorHandling", "globalService", "viewHistory", "modals", "api", function(
