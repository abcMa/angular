angular.module('app.controllers').controller('orderListCtrl', ["$scope", "$state", "$stateParams", "loadDataMixin", "orderService", "stateUtils", "cartService", "modals", "errorHandling", "payService", "messageCenter", "$translate", "api", "loading", "$ionicHistory", "$timeout", function (
