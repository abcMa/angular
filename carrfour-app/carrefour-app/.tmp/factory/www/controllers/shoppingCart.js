angular.module('app.controllers').controller('shoppingCartCtrl', ["$scope", "$state", "$stateParams", "$q", "$translate", "$ionicScrollDelegate", "cartService", "toast", "popup", "loadDataMixin", "checkoutService", "messageCenter", "loading", "userService", "errorHandling", "stateUtils", "collectService", "modals", "api", "$ionicHistory", "$timeout", function (
