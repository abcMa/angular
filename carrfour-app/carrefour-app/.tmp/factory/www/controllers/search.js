 ...
 * Tabs 的控制器
 */
angular.module('app.controllers').controller('searchCtrl', ["$scope", "$state", "$stateParams", "searchHistory", "stateUtils", "globalService", "loading", "$ionicScrollDelegate", "messageCenter", function(
