angular.module('app.controllers').controller('orderCommentListCtrl', ["$scope", "$params", "$stateParams", "loadDataMixin", "errorHandling", "commentService", "stateUtils", "$state", "modals", function (
