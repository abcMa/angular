 ...
 * });
 */
angular.module('app.controllers').controller('memberEditConsigneeInfoCtrl', ["$scope", "$params", "memberConsigneeService", "toast", "loading", "errorHandling", "messageCenter", "validator", "$translate", function(
    $scope, $params, memberConsigneeService, toast, loading, errorHandling, messageCenter,validator,$translate
) {
    ...
    angular.extend(this, messageCenter, {
        ...
        submit: function() {
            ...
            memberConsigneeService.addOrEdit(this.data)
        ...
        close: function() {
            $scope.modals.memberEditConsigneeInfo.close();
        }
    });
