angular.module('app.controllers').controller('feedbackOptionsCtrl', ["$rootScope", "$scope", "camera", "loadDataMixin", "modals", "validator", "toast", "$translate", "errorHandling", "feedbackOptionsServers", "api", "loading", function (
