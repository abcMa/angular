angular.module('app.controllers').controller('selectPayDeliveryCtrl', ["$scope", "$params", "stateUtils", "modals", "checkoutService", "loading", "errorHandling", "$translate", "$timeout", "$q", "messageCenter", "$ionicScrollDelegate", function(
