angular.module('app.controllers').controller('categoriesCtrl', ["$scope", "$state", "categoryService", "loadDataMixin", "stateUtils", "messageCenter", "$ionicScrollDelegate", "localStorage", function (
