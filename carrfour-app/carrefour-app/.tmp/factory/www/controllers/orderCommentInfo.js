angular.module('app.controllers').controller('orderCommentInfoCtrl', ["$scope", "$params", "$stateParams", "modals", "loadDataMixin", "errorHandling", "commentService", "api", "toast", "loading", "$translate", function(
