angular.module('app.controllers').controller('customerServiceCtrl', ["$scope", "loadDataMixin", "errorHandling", "customerService", "$state", "stateUtils", "messageCenter", function (
