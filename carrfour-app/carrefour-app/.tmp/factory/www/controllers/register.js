 ...
 * 注册弹出层控制器
 */
angular.module('app.controllers').controller('registerCtrl', ["$scope", "$state", "modals", "cmSwitcherDelegate", "globalService", "errorHandling", "userService", "$interval", "toast", "$translate", "validator", "messageCenter", "$ionicScrollDelegate", "loading", function (
