 ...
 * - data {Object} 默认数据
 *   */
angular.module('app.controllers').controller('editIdCardCtrl', ["$scope", "$params", "modals", "errorHandling", "loading", "validator", "toast", "$translate", "checkoutService", "$ionicPopup", function (
