 ...
 * 首页控制器
 */
angular.module('app.controllers').controller('indexCtrl', ["$scope", "$state", "modals", "$translate", "userService", "$timeout", "$ionicPlatform", "loadDataMixin", "$interval", "$ionicScrollDelegate", "$ionicSlideBoxDelegate", "stateUtils", "messageCenter", "indexService", "loading", "toast", "errorHandling", "$ionicHistory", "utils", "$stateParams", "localStorage", "messageCenterService", "overseasShopIndexService", "cartService", "shareService", function (
