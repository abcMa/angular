angular.module('app.controllers').controller('productListCtrl', ["$scope", "$state", "$stateParams", "$translate", "$ionicScrollDelegate", "productService", "cartService", "loadDataMixin", "stateUtils", "searchHistory", "loading", "errorHandling", "toast", "messageCenter", "modals", "localStorage", "$timeout", function (
