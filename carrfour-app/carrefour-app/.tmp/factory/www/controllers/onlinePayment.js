angular.module('app.controllers').controller('onlinePaymentCtrl', ["$scope", "$state", "$params", "loadDataMixin", "errorHandling", "payService", "modals", "$timeout", "messageCenter", "$translate", "applePay", "stateUtils", "$ionicScrollDelegate", "utils", function (
