angular.module('app.controllers').controller('storeInfoCtrl', ["$scope", "$state", "loadDataMixin", "$stateParams", "storeService", "modals", "toast", "$translate", "messageCenter", function (
