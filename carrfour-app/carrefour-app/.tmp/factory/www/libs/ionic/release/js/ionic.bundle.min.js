            ...
            __initEventHandlers: function () {
                ...
                if (i.scrollChildIntoView = function (t) {
                        ...
                        t.detail.isElementUnderKeyboard && e.requestAnimationFrame(function () {
                            ...
                            var s = .5 * n, l = (t.detail.elementBottom + t.detail.elementTop) / 2, c = l - a,
                                d = c + s;
                        ...
                        if (e.originalEvent && (e = e.originalEvent), M && y.emit("onTouchEnd", y, e), M = !1, x) {
                            ...
                            if (r = y.params.followFinger ? y.rtl ? y.translate : -y.translate : -P, y.params.freeMode) {
                                ...
                                if (y.params.freeModeMomentum) {
                                    ...
                                    G.length = 0;
                                    var c = 1e3 * y.params.freeModeMomentumRatio, d = y.velocity * c,
                                        u = y.translate + d;
                                    y.rtl && (u = -u);
                        ...
                        initialImageLoaded: !1, loadImageInSlide: function (e, n) {
                            if ("undefined" != typeof e && ("undefined" == typeof n && (n = !0), 0 !== y.slides.length)) {
                                ...
                                !i.hasClass("swiper-lazy") || i.hasClass("swiper-lazy-loaded") || i.hasClass("swiper-lazy-loading") || (r = r.add(i[0])), 0 !== r.length && r.each(function () {
                                    ...
                                    var r = e.attr("data-background"), a = e.attr("data-src"),
...
(function (O, U, t) {
    ...
    function We() {
        this.$get = function () {
            function b(b, d) {
                ...
                var g = 0, h = P({}, d, {id: b}), l = {}, k = d && d.capacity || Number.MAX_VALUE, n = {}, r = null,
                    s = null;
                return a[b] = {
                    put: function (a, b) {
                        if (!A(b)) {
    ...
    function ff() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function (c, d, e, f, g) {
            ...
            c.$watch(function () {
                var a =
                        Bb(d.url()), b = Bb(k.absUrl()), f = d.state(), g = k.$$replace,
    ...
    var jg = /^\/(.+)\/([a-z]*)$/, M = function (b) {
        ...
        }, Ua, y, la, za = [].slice, Mf = [].splice, kg = [].push, sa = Object.prototype.toString,
    ...
    var yf = /([\:\-\_]+(.))/g, zf = /^moz([A-Z])/, lg = {
        ...
        }, Ub = J("jqLite"), Cf = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Tb = /<|&#?\w+;/, Af = /<([\w:]+)/,
        Bf = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, na = {
    ...
    var wf = [function () {
        ...
        }], Wc = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, mg = /,/, ng = /^\s*(_?)(\S+?)\1\s*$/,
    ...
    var Zc = /^((?:x|data)[\:\-_])/i, Nf = J("$controller"), Xc = /^(\S+)(\s+as\s+(\w+))?$/, cd = "application/json",
        ac = {"Content-Type": cd + ";charset=utf-8"}, Pf = /^\[|^\{(?!\{)/, Qf = {"[": /]$/, "{": /}$/},
        Of = /^\)\]\}',?\n/,
    ...
    var da = J("$parse"), Uf = Function.prototype.call, Vf = Function.prototype.apply, Wf = Function.prototype.bind,
        Mb = ga();
    m("+ - * / % === !== == != < > <= >= && || ! = |".split(" "), function (a) {
        Mb[a] = !0
    });
    ...
    var Od = function (a) {
        ...
        }, je = Od(), we = Od(!0), ig = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/,
        rg = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,
        sg = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i,
        tg = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))([eE][+-]?\d+)?\s*$/, Pd = /^(\d{4})-(\d{2})-(\d{2})$/,
    ...
    var ye = ["$animate", function (a) {
        ...
        }, Be = Ma({terminal: !0, priority: 1E3}), yg = J("ngOptions"),
...
(function (F, t, W) {
    ...
    var H = t.noop, ya = t.extend, G = t.element, u = t.forEach, X = t.isArray, U = t.isString, na = t.isObject,
        Ka = t.isUndefined, La = t.isDefined, Ca = t.isFunction, oa = t.isElement, O, pa, V, qa;
    ...
    t.module("ngAnimate",
        ...
        function (a) {
            ...
            this.$get = ["$$rAF", "$rootScope", "$rootElement", "$document", "$$HashMap", "$$animation", "$$AnimateRunner", "$templateRequest", "$$jqLite", function (d, s, n, h, k, D, A, Z, I) {
                ...
                function r(a, S, p) {
                    ...
                    if (!v(e)) return g(), l;
                    var M = 0 <= ["enter", "move", "leave"].indexOf(S), h = !x || L.get(P), e = !h && m.get(P) || {},
                        k = !!e.state;
                    ...
                    s.$$postDigest(function () {
                        var b = m.get(P), v = !b, b = b || {}, e = a.parent() || [],
        ...
        this.$get = ["$window", "$$jqLite", "$$AnimateRunner", "$timeout", "$document", "$sniffer", "$$rAFScheduler", function (a,
            ...
            return function (a, c) {
                ...
                var Y = [R, N].join(" ").trim(), fa = r + " " + Y, W = ba(Y, "-active"),
...
(function (n, h, p) {
    ...
    var L = h.$$minErr("$sanitize"),
        ...
        y = /^<\/\s*([\w:-]+)[^>]*>/, G = /([\w:-]+)(?:\s*=\s*(?:(?:"((?:[^"])*)")|(?:'((?:[^'])*)')|([^>\s]+)))?/g,
        K = /^</, J = /^<\//, H = /\x3c!--(.*?)--\x3e/g, x = /<!DOCTYPE([^>]*?)>/i,
        I = /<!\[CDATA\[(.*?)]]\x3e/g, M = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g, N = /([^\#-~| |!])/g,
    ...
    var w = g("script,style"), C = h.extend({}, v, s, t, u, n),
...
!function () {
    function e(e, t, n, i, o, r) {
        function a(i, a, c, s, u) {
            ...
            var T, B = C[1], I = C[2], x = t(I), A = {}, E = {}, V = {}, P = [],
                _ = c.itemRenderBuffer || c.collectionBufferSize, D = angular.isDefined(_) ? parseInt(_) : y,
    ...
    function t(e, t, n) {
        ...
        return function (o) {
            ...
            var v, g, m = o.afterItemsNode, $ = o.containerNode, y = o.forceRefreshImages, S = o.heightData,
                k = o.widthData, C = o.keyExpression, T = o.renderBuffer, B = o.scope, I = o.scrollView,
                x = o.transclude, A = [], E = {}, V = S.getValue || function () {
                    return S.value
                }, P = function (e, t) {
            ...
            this.refreshLayout = function () {
                ...
                var a = $.previousElementSibling, c = a ? t.getComputedStyle(a) : {},
    ...
    a.factory("$ionicActionSheet", ["$rootScope", "$compile", "$animate", "$timeout", "$ionicTemplateLoader", "$ionicPlatform", "$ionicBody", "IONIC_BACK_PRIORITY", function (e, t, n, i, o, r, a, s) {
        ...
        var b, y, S, k, C, T = "initialView", B = "newView", I = "moveBack", x = "moveForward", A = "back",
            E = "forward", V = "enter", P = "exit", _ = "swap", D = "none", L = 0, R = {
    ...
    a.factory("$ionicPopup", ["$ionicTemplateLoader", "$ionicBackdrop", "$q", "$timeout", "$rootScope", "$ionicBody", "$compile", "$ionicPlatform", "$ionicModal", "IONIC_BACK_PRIORITY", function (e, t, n, i, o, r, a, s, l, u) {
        ...
        var y = {stackPushDelay: 75}, S = [],
            k = {show: v, alert: m, confirm: w, prompt: b, _createPopup: d, _popupStack: S};
        return k
        ...
        function d(e, t, n, i) {
            var r = u(e), a = g || V(t, "view-transition") || r.viewTransition || o.views.transition() || "ios",
        ...
        var g, m, $ = "webkitTransitionEnd transitionend", w = "$noCache", b = "$destroyEle", y = "$eleId",
            S = "$accessed", k = "$fallbackTimer", C = "$viewData", T = "nav-view", B = "active", I = "cached",
            x = "stage", A = 0;
        ...
        h.beforeEnter = function (t) {
            ...
            var i, o, r, h, p, v, g, m, $, w = a(c), y = a(l), S = t[0].childNodes, k = 0, C = 0, T = 0, B = 0, I = "",
                x = 0;
        ...
        var m, $, w, b = "hide", y = "$ionNavBarController", S = "primaryButtons", k = "secondaryButtons",
            C = "backButton", T = "primaryButtons secondaryButtons leftButtons rightButtons title".split(" "), B = this,
            I = [], x = {}, A = !0;
        t.parent().data(y, B);
        ...
        var m, $, w, b, y, S = "$eleId", k = "$destroyEle", C = "$noCache", T = "active", B = "cached", I = this,
            x = !1, A = l.navViewAttr;
