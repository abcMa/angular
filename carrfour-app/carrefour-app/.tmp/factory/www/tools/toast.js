    ...
    _.assign(Toast.prototype, {
        ...
        _show: function(toastContainer) {
            ...
            ionic.requestAnimationFrame(function() {
                ...
                var keyBoardHeight;
                if(window.cordova && window.cordova.plugins && window.cordova.plugins.Keyboard && cordova.plugins.Keyboard.isVisible && window.keyBoardHeight){
                    keyBoardHeight = window.keyBoardHeight + 80 + "px";
                    toastContainer.toastElement.css('bottom', keyBoardHeight);
                }
            });
