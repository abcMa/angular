angular.module('app.directives').directive('activityPage', ["$compile", function(
    $compile
) {
    return {
        restrict: 'E',
...
angular.module('app.services').provider('activityLoader', ["$controllerProvider", "$injector", function(
