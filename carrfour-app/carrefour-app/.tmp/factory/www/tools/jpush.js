...
angular.module('app.services')
    .factory('jPushService', ["jPushManager", "jPushReceiver", "$ionicPlatform", function (jPushManager, jPushReceiver, $ionicPlatform) {
        return {
            init: function () {
 ...
 */
angular.module('app.services')
    .factory('jPushReceiver', ["messageCenterService", function (messageCenterService) {
 ...
 * 极光推送 - 控制器
 */
angular.module('app.services').factory('jPushManager', ["$rootScope", "messageCenter", "utils", function ($rootScope, messageCenter, utils) {
    var tagContainer = {};
    var alias = "";
