...
// 配置搜索历史记录
app.config(["searchHistoryProvider", function (searchHistoryProvider) {
...
// 定义全局的返回方法
app.run(["$rootScope", "stateUtils", "$ionicViewSwitcher", "$ionicHistory", "$state", "overseasShop", function ($rootScope, stateUtils, $ionicViewSwitcher, $ionicHistory, $state, overseasShop) {
...
// 二维码扫描和他的处理
app.run(["$rootScope", "$translate", "loading", "stateUtils", "toast", "scanService", "productService", function ($rootScope, $translate, loading, stateUtils, toast, scanService, productService) {
    // 扫码
...
// 设置 unique
app.run(["unique", function (unique) {
...
// 监听锁屏事件
app.run(["$ionicPlatform", "messageCenter", function ($ionicPlatform, messageCenter) {
    // 锁屏
...
// 设置用户信息
app.run(["$ionicPlatform", "localStorage", "messageCenter", "$rootScope", "viewHistory", "cartService", function ($ionicPlatform, localStorage, messageCenter, $rootScope, viewHistory, cartService) {
...
// 还原分站信息
app.run(["localStorage", "messageCenter", "globalService", function (localStorage, messageCenter, globalService) {
    var emptySubsite = {
        "breadNavigator": []
    };
...
// 还原语言信息
app.run(["localStorage", "$translate", function (localStorage, $translate) {
...
// 全球购标识自动切换
app.run(["$state", "$rootScope", "overseasShop", function ($state, $rootScope, overseasShop) {
...
app.run(["messageCenter", "cmSwitcherDelegate", "modals", "$state", "$ionicPopup", "$translate", function (messageCenter, cmSwitcherDelegate, modals, $state, $ionicPopup, $translate) {
...
app.config(["$stateProvider", "tabs", "states", "platformStates", "statesForEveryTab", "platformStatesForEveryTab", "statesForOverseasShop", function ($stateProvider, tabs, states, platformStates, statesForEveryTab, platformStatesForEveryTab, statesForOverseasShop) {
...
app.run(["$rootScope", "stateUtils", function ($rootScope, stateUtils) {
...
app.run(["$rootScope", "$state", "$ionicModal", "$controller", "modals", "messageCenter", function ($rootScope, $state, $ionicModal, $controller, modals, messageCenter) {
